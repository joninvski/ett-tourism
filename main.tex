...
We developed an Android application which displays \acp{POIs}, Events and Itineraries following a user's criteria, e.g using categorical information and/or using coordinates. 
...
Also, our API provides opportunities to create new businesses that either give more detailed information on our data models, or create new applications that may use our data in new ways.

Museums and other venues can provide useful information in two different ways: 
\begin{enumerate}
\item By providing information regarding pricings, the number of people that can be accommodated, queue's lenght and waiting time or even information on handicaped access;
\item By creating more detailed information and integrating themselves into the API due to our delegation model.
\end{enumerate} 
