...
At last, a Augmented Reality application using the Layar framework\footnote{http://www.layar.com/} was also created by developing a PHP web-server, thus using the PHP library. 
