...
{"categories": [{
   ...
   "link": [{
     "term": "icon",
     "value": "http://someurl.com/housing.png",
     "type": "image/png"
    }
   ],
   "categories": [{
...
\end{lstlisting}
\caption{Categories Message Format}
\label{fig:cat-format}
\end{figure}
...
\end{lstlisting}
\caption{Tags Message Format}
\label{fig:tag-format}
\end{figure}
