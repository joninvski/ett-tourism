...
Municipalities understand the value of this data and many have gone through a multi-step process for sharing this data with tourists in order to improve their experience and attract them to the city.
...
Still, the open-data model is not without flaws as each entities publishes different datasets using different data formats.
...
These factors will limit the cities covered by an applications and thus their potential market, limiting the number and size of the investments.
